...
{
    public partial class CustomerLogin : Form, ICustomerLogin
    {
        ...
        public void lforgotpass_Click(object sender, EventArgs e)
        {
            lforgotpass.ForeColor = Color.Green;
            tbusername.Text = string.Empty;
            tbpass.Text = string.Empty;

            this.Visible = false;
            ForgotPasswordHome x = new ForgotPasswordHome();
            x.Visible = true;
        }
        ...
        public void blogin_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT * FROM CUSTOMER WHERE USERNAME = @username COLLATE Latin1_General_BIN AND PASSWORD = @password COLLATE Latin1_General_BIN AND ACCOUNT_STATUS=@status", con);
            ...
            else if (dt.Rows.Count > 0 && check == ans)
            {
                ...
                this.Visible = false;
                CustomerHomePage x = new CustomerHomePage(username);
                x.Visible = true;
            }
            else
            {
        ...
        public void lblForgotPass_MouseEnter(object sender, EventArgs e)
        {
            // Mouse enter= red.
            lforgotpass.ForeColor = Color.Red;
        }
        public void lblForgotPass_MouseLeave(object sender, EventArgs e)
        {
            // mouse exit =White.
            lforgotpass.ForeColor = Color.White;
        }
